...
VALUES (uuid_generate_v4(),'Cheese 4 u',230,'mozzarella, tilsiter, parmesan, dor blue and tasty sauce only 4 u','https://drive.google.com/thumbnail?id=1pYq2b9pZuk4M6J8eK91N4cMAB8cPh7li'),
       ...
       (uuid_generate_v4(),'Shrimp paradise',720,'Will you ever taste it?Shrimp, cheese and flavoring, somewhere one italian dies when hear that combo...','https://drive.google.com/thumbnail?id=10W-T03HcE79M0QfArJrD0V-US-eawI4l'),
       ...
       (uuid_generate_v4(),'Victor''s secret',21000,'V think this is funny, but we think that is too much','https://drive.google.com/thumbnail?id=1yFtxPKAqlGkGksT0E8BKBHmy1ITj3aod'),
...
VALUES (uuid_generate_v4(),'ttt','$2a$08$IBofPRr1u3qKN9vlQWXhAeJmVslTxTkImF6ZLaKI3Q425MC/IIb.m','ROLE_ADMIN');

INSERT INTO cart(id,createdIn)
VALUES (uuid_generate_v4(),'2024-10-14');