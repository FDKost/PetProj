...
public class AddressDao {
    ...
    public Long createAddress(Address address){
        String sql = "INSERT INTO address (id_user, street, house, apartment) VALUES (:id_user,:street,:house,:apartment) RETURN id_cart";
    ...
    public Address getAddressById(long id_address){
        ...
        return template.queryForObject(sql,parameterSource,(rs,rowNum)->{
            ...
            address.setId_user(rs.getLong("id_user"));
    ...
    public void editAddress(Address address){
        String sql = "UPDATE address SET (house,apartment,street) VALUES (:house,:apartment,:street)";
